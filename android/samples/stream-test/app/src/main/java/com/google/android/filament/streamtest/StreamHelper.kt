...
class StreamHelper(val activity: Activity, private val filamentEngine: Engine, private val filamentMaterial: MaterialInstance, private val display: Display, private val externalTextureId: Int) {
    ...
    enum class StreamSource {
        ...
        CANVAS_DIRECT_IMAGE,   // synchronized and copy-free
    }
    ...
    fun repaintCanvas() {
        ...
        if (surface != null) {
            ...
            if (streamSource == StreamSource.CANVAS_DIRECT_IMAGE) {
                ...
                val synchronizedImage = Texture.SynchronizedImage(eglImageOES, directImageHandler, releaseImage)
                filamentTexture!!.setSynchronizedImage(filamentEngine, synchronizedImage )
            }
        }
